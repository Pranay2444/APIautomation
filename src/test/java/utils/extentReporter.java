...
// add dependencies
// utiltities extentReporting --> ITestListener
// executing using textNg.xml
// synchronised = Threads should be created --> 1 single report all the test result --> when one Test completed then anotheer will start